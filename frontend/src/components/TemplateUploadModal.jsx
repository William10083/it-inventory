...
const SYSTEM_FIELDS = [
    ...
    { label: '--- General ---', value: 'disabled_0', disabled: true },
    { value: 'ITEM', label: 'N° de Item (correlativo de empleados)', sample: '101' },
    { value: 'NOMBRE_TI', label: 'Nombre del TI (usuario logueado)', sample: 'WILLIAM VILCA' },
    { value: 'DNI_TI', label: 'DNI del TI (usuario logueado)', sample: '76223277' },
    { value: 'OTROS_COMENTARIOS', label: 'Otros Comentarios', sample: 'ASIGNACION DE EQUIPO' },
    { value: 'TIPO_ASIGNACION', label: 'Tipo de Asignación', sample: 'ASIGNACION' },
    ...
    { value: 'MONITOR_SERIAL', label: 'Monitor - Nro. Serie', sample: 'VNA123456' },
    { value: 'MONITOR_INVENTORY_CODE', label: 'Monitor - Código Inventario', sample: 'INV-MON-001' },
    { label: '--- Cargador Laptop ---', value: 'disabled_chg', disabled: true },
    { value: 'CARGADOR_BRAND', label: 'Cargador Laptop - Marca', sample: 'HP' },
    { value: 'CARGADOR_MODEL', label: 'Cargador Laptop - Modelo', sample: 'TPN-DA15' },
    { value: 'CARGADOR_SERIAL', label: 'Cargador Laptop - Nro. Serie', sample: '-' },
    { label: '--- Mochila ---', value: 'disabled_moch', disabled: true },
    { value: 'MOCHILA_BRAND', label: 'Mochila - Marca', sample: 'TARGUS' },
    { value: 'MOCHILA_MODEL', label: 'Mochila - Modelo', sample: 'TSB195' },
    { value: 'MOCHILA_SERIAL', label: 'Mochila - Nro. Serie', sample: '-' },
    { value: 'MOCHILA_INVENTORY_CODE', label: 'Mochila - Código Inventario', sample: 'INV-MOCH-001' },
    { label: '--- Teclado ---', value: 'disabled_7', disabled: true },
    { value: 'TECLADO_BRAND', label: 'Teclado - Marca', sample: 'LOGITECH' },
    { value: 'TECLADO_MODEL', label: 'Teclado - Modelo', sample: 'MK270' },
    { value: 'TECLADO_SERIAL', label: 'Teclado - Nro. Serie', sample: 'TECLADO123' },
    { value: 'TECLADO_INVENTORY_CODE', label: 'Teclado - Código Inventario', sample: 'INV-TEC-001' },
    { label: '--- Mouse ---', value: 'disabled_8', disabled: true },
    { value: 'MOUSE_BRAND', label: 'Mouse - Marca', sample: 'LOGITECH' },
    { value: 'MOUSE_MODEL', label: 'Mouse - Modelo', sample: 'M185' },
