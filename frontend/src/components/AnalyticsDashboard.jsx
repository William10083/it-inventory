...
const AnalyticsDashboard = ({ employees, locationFilter = 'all' }) => {
    ...
    const { employeesComplete, coverageRate } = useMemo(() => {
        const complete = employeesFiltered.filter(e => {
            ...
            const mobileOk = isPracticante || types.includes('celular');
            if (!laptopOk) return false;
            if (!isChofer && (!types.includes('monitor') || !kitOk || !types.includes('mochila') || !types.includes('auriculares'))) return false;
        ...
        const filtered = employeesFiltered
            .map(e => {
                ...
                if (laptopCount < expectedLaptops) {
                    ...
                    missing.push({ label: diff > 1 ? `${diff} Laptops` : 'Laptop', color: 'bg-red-500/20 text-red-400 border-red-500/30' });
                }
                ...
                if (!isChofer) {
                    ...
                    if (!hasKit) missing.push({ label: 'Kit T/M', color: 'bg-purple-500/20 text-purple-400 border-purple-500/30' });
    ...
    if (loading) return <div className="text-white p-8">Cargando Analytics...</div>;
    if (!stats) return <div className="text-red-400 p-8">Error al cargar estadísticas.</div>;
        ...
        <div className="space-y-8 animate-fade-in pb-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="bg-slate-900/50 p-4 rounded-lg">
                                <div className="flex justify-between items-start mb-2">
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold text-white">{lowStockItems.length} tipos</p>
                                    </div>
                        ...
                        {unassignedEmployees.length > 0 && (
                            <div className="bg-slate-900/50 p-4 rounded-lg">
                                <div className="flex justify-between items-start mb-2">
                                    <div>
                                        <p className="text-slate-400 text-sm">Empleados Sin Equipos</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="glass-card p-6 border-l-4 border-green-500">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-slate-400 text-sm">Tasa de Asignación</p>
                            <h3 className="text-3xl font-bold text-white mt-1">{assignmentRate}%</h3>
                            <p className="text-xs text-green-400 mt-1">{assignedCount} de {stats.total_devices} equipos</p>
                        </div>
                ...
                <div className="glass-card p-6 border-l-4 border-purple-500">
                    <div className="flex justify-between items-start">
                        <div>
                            <p className="text-slate-400 text-sm">Cobertura Completa</p>
                            <h3 className="text-3xl font-bold text-white mt-1">{coverageRate}%</h3>
            ...
            {stats.equipment_summary && (
                <div className="glass-card p-6">
                    <div className="mb-4">
                        ...
                        <p className="text-slate-400 text-sm">Estado completo: asignados, pendientes y disponibles</p>
                    </div>
